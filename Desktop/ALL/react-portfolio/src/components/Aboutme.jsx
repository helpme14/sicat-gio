    ...
    <div className='grid grid-cols-1 gap-4 lg:grid-cols-2'>
      ...
      <div name="section2" className='text-white'>
        ...
        <div className='my-4 bg-gradient-to-b from-[#111827] via-slate-600 to-gray-800 pb-2 border border-t-0 border-r-0 border-l-0 duration-300 hover:scale-105 hover:rounded-xl shadow-md shadow-[#FFA500]'>
          <h1 className='text-xl text-center uppercase'>About me</h1>
          <p className='mx-4'>
        ...
        <div className='my-4 bg-gradient-to-b from-[#111827] via-slate-600 to-gray-800 pb-2 border border-t-0 border-r-0 border-l-0 duration-300 hover:scale-105 hover:rounded-xl shadow-md shadow-[#FFA500]'>
          <h1 className='text-xl text-center uppercase'>Achievements</h1>
          <p className='mx-4'>
        ...
        <div className='my-4 bg-gradient-to-b from-[#111827] via-slate-600 to-gray-800 pb-2 border border-t-0 border-r-0 border-l-0 duration-300 hover:scale-105 hover:rounded-xl shadow-md shadow-[#FFA500]'>
          <h1 className='text-xl text-center uppercase'>Passion for Programming</h1>
          <p className='mx-4'>
        ...
        <div className='my-4 bg-gradient-to-b from-[#111827] via-slate-600 to-gray-800 pb-2 border border-t-0 border-r-0 border-l-0 duration-300 hover:scale-105 hover:rounded-xl shadow-md shadow-[#FFA500]'>
          <h1 className='text-xl text-center uppercase'>Beyond Graduation</h1>
          <p className='mx-4'>
      ...
      {/* Social Media Links */}
      <div className='flex flex-row rounded-md text-white col-span-1 shadow-md shadow-[#FFA500] my-10 p-0 lg:p-6'>

        <div className='flex items-center justify-center gap-5 p-2 mx-4'>
          <div><h1>Links: </h1></div>
